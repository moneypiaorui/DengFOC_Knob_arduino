...
LowPassFilter angleflt = LowPassFilter(0.01); // 旋钮 阻尼/顺滑
// 阻尼模式
void Current_Detents_Mode()
{
    // DFOC_M0_setTorque(0); // 电压力矩
    DFOC_M0_setTorque(34 * (angleflt(DFOC_M0_Angle()) - DFOC_M0_Angle()));//滤波后力矩滞后
}
...
void Current_NO_Detents_Mode()
{
    ...
    DFOC_M0_setTorque(-5.5* (angleflt(DFOC_M0_Angle()) - DFOC_M0_Angle()));//滤波后力矩超前
}
